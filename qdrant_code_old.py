...
def interactive_search():
    ...
    while True:
        try:
            ...
            if documents:
                print(f"\nðŸ“‹ Found {len(documents)} relevant documents:\n")
                ...
                print("âŒ No relevant documents found.")
...
def main():
    ...
    if command == "rebuild":
        ...
        if success:
            print("\nâœ… Vector store rebuild completed successfully!")
            print("You can now run 'python qdrant_rag.py search' to start searching.")
        else:
            print("\nâŒ Vector store rebuild failed.")
